          ...
          <aside className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-md p-6 sticky top-24">
              ...
              <div className="text-center mb-6 pb-6 border-b border-gray-200">
                <div className="w-20 h-20 bg-gradient-to-r from-rose-500 to-pink-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-3xl font-bold">
              ...
              <button
                ...
                className="w-full text-right px-4 py-3 rounded-xl text-red-600 hover:bg-red-50 transition-all flex items-center gap-3"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <main className="lg:col-span-3">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                  <div className="bg-white rounded-xl p-4 shadow-md">
                    <p className="text-sm text-gray-600 mb-1">کل سفارش‌ها</p>
                ...
                <div className="bg-white rounded-2xl shadow-md">
                  <div className="p-6 border-b border-gray-200">
                    <h2 className="text-xl font-bold text-gray-900">تاریخچه سفارش‌ها</h2>
                  </div>
                        ...
                        return (
                          <div key={order.id} className="p-6 hover:bg-gray-50 transition">
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                              <div>
                                ...
                                <p className="text-sm text-gray-500">
                                  تاریخ: {orderDate.toLocaleDateString('fa-IR')} - {orderDate.toLocaleTimeString('fa-IR', { hour: '2-digit', minute: '2-digit' })}
                                </p>
                              </div>
                            ...
                            <div className="flex items-center gap-2 mb-4">
                              <p className="text-sm text-gray-600">محصولات:</p>
                              <div className="flex-1 flex flex-wrap gap-2">
                                {items.slice(0, 3).map((item: any, idx: number) => (
                                  <span key={idx} className="text-sm text-gray-700 bg-gray-100 px-3 py-1 rounded-lg">
                                ...
                                {['pending', 'processing', 'shipped', 'delivered'].map((status, idx) => {
                                  ...
                                  return (
                                    <div key={status} className="flex flex-col items-center flex-1">
                                      ...
                                      <p className={`text-xs ${isActive && !isCancelled ? 'text-gray-900 font-medium' : 'text-gray-400'}`}>
            ...
            {activeTab === 'profile' && (
              <div className="bg-white rounded-2xl shadow-md p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-6">اطلاعات پروفایل</h2>
