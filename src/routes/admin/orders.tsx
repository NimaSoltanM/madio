...
function OrdersManagement() {
  ...
  const parseShippingInfo = (shippingJson: string) => {
    try {
  ...
  return (
    <div>
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">مدیریت سفارش‌ها</h1>
        <p className="text-gray-600">{orders.length} سفارش</p>
      </div>

      {/* Filter Tabs */}
      <div className="flex flex-wrap gap-2 mb-6">
        <button className="px-4 py-2 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-lg font-medium">
          همه ({orders.length})
        </button>
        <button className="px-4 py-2 bg-white text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition">
        ...
        <div className="overflow-x-auto">
          ...
          {orders.length === 0 && (
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">هنوز سفارشی ثبت نشده</h3>
              <p className="text-gray-600">سفارش‌های ثبت شده در اینجا نمایش داده می‌شوند</p>
            </div>
          )}
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full my-8">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-xl p-4 space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">{selectedOrder.expand?.user?.email}</span>
                  </div>
                </div>
              </div>
              ...
              {selectedOrder.shippingInfo && (() => {
                ...
                return shipping ? (
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">اطلاعات ارسال</h3>
                    <div className="bg-gray-50 rounded-xl p-4 space-y-2">
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-900">{shipping.postalCode}</span>
                      </div>
                      <div className="pt-2 border-t border-gray-200">
                        <span className="text-gray-600 text-sm">آدرس:</span>
                        <p className="font-medium text-gray-900 mt-1">{shipping.address}</p>
                      </div>
                      {shipping.notes && (
                        <div className="pt-2 border-t border-gray-200">
                          <span className="text-gray-600 text-sm">یادداشت:</span>
                          <p className="text-gray-700 mt-1">{shipping.notes}</p>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              {/* Order Items */}
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">محصولات</h3>
